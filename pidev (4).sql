...
ALTER TABLE `users` ADD UNIQUE(`telephone`);
ALTER TABLE `hopital` CHANGE `type` `type` VARCHAR(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
ALTER TABLE `users` ADD `id_usr` INT NOT NULL AUTO_INCREMENT FIRST, ADD UNIQUE (`id_usr`);
ALTER TABLE `medicament` CHANGE `user` `usrRole` VARCHAR(12) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL;
ALTER TABLE `service` CHANGE `nom` `type` VARCHAR(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL;
ALTER TABLE `users` CHANGE `user` `user` VARCHAR(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL;
